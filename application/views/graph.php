                            ...
                            <div class="h-100">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Low vuln</p>
                                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                     <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Medium vuln</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">High vuln</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <h5 class="text-success fs-14 mb-0">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Critical vuln</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header border-0 align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Threatened</h4>
                                            </div><!-- end card header -->
                                            <div class="card-body p-0 pb-2">
                                                <div class="w-100">
                                                    <figure class="highcharts-figure">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header border-0 align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Email Risk</h4>
                                            </div><!-- end card header -->
                                            <div class="card-body p-0 pb-2">
                                                <div class="w-100">
                                                    <figure class="highcharts-figure">
